...
def choose_table():
    ...
    with open("pool_table_data.json", "r") as json_object:
        ...
        print("Table {pool_table_number[table_selection - 1]['pool_table_number']}")
...
def end_table():
    ...
    with open("pool_table_data.json", "r") as json_object:
        ...
        if (occupancy != "0"):
            ...
            if (end == 'y'):
                pool_table_number[table_selection - 1]["end_date_time"] = datetime.datetime.now().time().strftime('%H:%M:%S')
                ...
                with open("pool_table_history.json", "a") as json_object:
                    json.dump(pool_table_number[table_selection - 1],json_object)
                ...
                with open("pool_table_data.json", "w") as json_object:
                    ...
                    json.dump(pool_table_number[table_selection - 1]["start_date_time"] = "0",json_object)
                    json.dump(pool_table_number[table_selection - 1]["end_date_time"] = "0",json_object)
